...
import { ChevronDown, Languages, Menu, MoreHorizontal, Moon, Sun } from 'lucide-react'
...
import FusionKeysPage from '@/pages/FusionKeysPage'
...
function Brand() {
  return (
    <Link to="/" className="flex items-center gap-2 transition-opacity hover:opacity-70">
      <svg width="20" height="20" viewBox="0 0 64 64" className="size-5" xmlns="http://www.w3.org/2000/svg">
        <rect width="64" height="64" rx="14" fill="currentColor" className="text-foreground" />
        <circle cx="32" cy="32" r="9.5" fill="currentColor" className="text-background" />
        <circle cx="32" cy="32" r="18" fill="none" stroke="currentColor" strokeOpacity=".4"
                strokeWidth="3.5" strokeLinecap="round" strokeDasharray="86 27"
                transform="rotate(-60 32 32)" className="text-background" />
      </svg>
...
<Route path="/fusion-keys" element={<FusionKeysPage />} />
