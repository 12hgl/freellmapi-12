...
// FreeQWQ — free-tier OpenAI-compatible aggregator (api.freeqwq.com/v1).
// 内置公共匿名密钥开箱即用；在 freeqwq.com 注册账号可获得更高频率限制的个人 API Key。
// keyless=true 支持匿名访问，同时在密钥管理页面可添加个人 API Key 覆盖默认值。
register(new OpenAICompatProvider({
  platform: 'freeqwq',
  name: 'FreeQWQ',
  baseUrl: 'https://api.freeqwq.com/v1',
  timeoutMs: 60_000,
  keyless: true,
}));
